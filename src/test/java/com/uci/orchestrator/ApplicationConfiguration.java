...
//		return new ReactiveConsumer(new Flux<ReceiverRecord<String, String>>() {
//			@Override
//			public void subscribe(CoreSubscriber<? super ReceiverRecord<String, String>> coreSubscriber) {
//
//
//			}
//		});
//	}
	...
	/**
	 * below these methods are from AppConfigOrchestrator.java
	 * @return
	 */
...
//				"<?xml version=\"1.0\"?>\n" +
//						"<xMessage>\n" +
//						"    <app>897fb6ea-cb07-4891-b714-1e86784ef610</app>\n" +
...
//						"    <timestamp>1595137277407</timestamp>\n" +
//						"    <transformers>\n" +
//						"        <id>2</id>\n" +
//						"        <metaData>\n" +
//						"            <entry>\n" +
